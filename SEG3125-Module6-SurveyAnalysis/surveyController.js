...
module.exports = function(app){
    ...
    app.get('/analysis', function(req, res){
        var videogame = readData("videogame");
        var console = readData("console");
        var genre = readData("genre");
        var favoriteGame = readData("favoriteGame");
        var hoursPlayed = readData("hoursPlayed");
        var ageRange = readData("ageRange");

        res.render('showResults', {results: [videogame, console, genre, favoriteGame, hoursPlayed, ageRange]});
    });
